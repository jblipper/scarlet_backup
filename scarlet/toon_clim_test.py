...
def get_thermal_1d(nlevel, wno,nwno, numg,numt,tlevel, dtau, w0,cosb,plevel, ubar1,
    ...
    if calc_type == 0: 
        ...
        all_b = fluxes.blackbody_integrated(tlevel, wno, dwno)
...
plt.savefig('clim_toon_up_top.png')
plt.clf()
...
plt.xlabel('Wavelength')
plt.ylabel('Intensity')
plt.ylim(-1000,450000)
plt.savefig('clim_toon_down_top.png')
plt.clf()
...
plt.ylabel('Intensity')
plt.ylim(-1000,300000)
plt.savefig('clim_toon_up_mid.png')
plt.clf()
...
plt.ylabel('Intensity')
plt.ylim(-1000,450000)
plt.savefig('clim_toon_down_mid.png')
plt.clf()
...
plt.ylabel('Intensity')
plt.ylim(-3000,7000)
plt.savefig('clim_toon_up_test.png')
plt.clf()
