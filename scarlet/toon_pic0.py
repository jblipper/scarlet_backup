...
def multiScatToon(atm,IrradStar,extinctCoef0,scatCoef0,asym = 0,u0 = 0.5773502691896258,refl = False,thermal = True,calcJ = False,intTopLay=0,method ='Hemispheric Mean',w=-1):
